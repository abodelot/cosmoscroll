...
$(EXEC): Asteroid.o Blorb.o Blorb2.o BulletManager.o ControlPanel.o Entity.o Game.o GameOver.o Intro.o Main.o MediaManager.o ParticleSystem.o PlayerShip.o Weapon.o
	$(CC) $^ -o $(EXEC) $(LDFLAGS)
