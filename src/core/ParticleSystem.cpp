...
void ParticleSystem::AddMessage(const sf::Vector2f& offset, const sf::String& text, const sf::Color& color)
{
...
ParticleSystem::TextParticle::TextParticle(const sf::Vector2f& offset, const sf::String& text, const sf::Color& color)
{
