...
public:
     ...
     */
    void resetParticle(ParticleSystem::Particle& particle) const;
     ...
     */
    virtual void onParticleCreated(ParticleSystem::Particle&) const {};

    /**
     * Override this method to implement a new behavior when particle is updated
     */
    virtual void onParticleUpdated(ParticleSystem::Particle&, float) const {};
